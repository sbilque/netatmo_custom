...
class Room(NetatmoBase):
    ...
    def update(self, raw_data: RawData) -> None:
        ...
        self.therm_setpoint_start_time = raw_data.get(
        ...
        self.cooling_setpoint_temperature = raw_data.get(
            "cooling_setpoint_temperature")
        self.cooling_setpoint_start_time = raw_data.get(
            "cooling_setpoint_start_time")
            ...
            if module.device_type == "NLC" and module.appliance_type == ApplianceType.radiator:
                ...
                if not (state is None):
                    if self.reachable is None:
                        ...
                        self.reachable = (self.reachable and state)
    ...
    def setpoint_fp(self) -> str | None:
        ...
        return (
            self.therm_setpoint_fp or None
        )
